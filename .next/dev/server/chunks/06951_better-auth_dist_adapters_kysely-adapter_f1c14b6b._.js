module.exports = [
"[project]/mystery-santa/node_modules/better-auth/dist/adapters/kysely-adapter/kysely-adapter.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const kyselyAdapter = (db, config)=>{
            ...
            const selectAllJoins = (join)=>{
                ...
                if (join) for (const [joinModel, _] of Object.entries(join)){
                    ...
                    for (const [field, fieldAttr] of Object.entries(fields)){
                        allSelects.push(__TURBOPACK__imported__module__$5b$project$5d2f$mystery$2d$santa$2f$node_modules$2f$kysely$2f$dist$2f$esm$2f$raw$2d$builder$2f$sql$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["sql"]`${__TURBOPACK__imported__module__$5b$project$5d2f$mystery$2d$santa$2f$node_modules$2f$kysely$2f$dist$2f$esm$2f$raw$2d$builder$2f$sql$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["sql"].ref(`join_${joinModelName}`)}.${__TURBOPACK__imported__module__$5b$project$5d2f$mystery$2d$santa$2f$node_modules$2f$kysely$2f$dist$2f$esm$2f$raw$2d$builder$2f$sql$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["sql"].ref(fieldAttr.fieldName || field)} as ${__TURBOPACK__imported__module__$5b$project$5d2f$mystery$2d$santa$2f$node_modules$2f$kysely$2f$dist$2f$esm$2f$raw$2d$builder$2f$sql$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["sql"].ref(`_joined_${joinModelName}_${fieldAttr.fieldName || field}`)}`);
                        allSelectsStr.push({
                            joinModel,
    ...
    adapterOptions = {
        config: {
            ...
            transaction: config?.transaction ? (cb)=>db.transaction().execute((trx)=>{
                    return cb((0, __TURBOPACK__imported__module__$5b$project$5d2f$mystery$2d$santa$2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$db$2f$adapter$2f$factory$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["createAdapterFactory"])({
    ...
    const adapter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$mystery$2d$santa$2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$db$2f$adapter$2f$factory$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["createAdapterFactory"])(adapterOptions);
    return (options)=>{
        lazyOptions = options;
...
"[project]/mystery-santa/node_modules/better-auth/dist/adapters/kysely-adapter/index.mjs [middleware] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/mystery-santa/node_modules/better-auth/dist/adapters/kysely-adapter/index.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "createKyselyAdapter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$mystery$2d$santa$2f$node_modules$2f$better$2d$auth$2f$dist$2f$adapters$2f$kysely$2d$adapter$2f$dialect$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["createKyselyAdapter"],
    "getKyselyDatabaseType",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$mystery$2d$santa$2f$node_modules$2f$better$2d$auth$2f$dist$2f$adapters$2f$kysely$2d$adapter$2f$dialect$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["getKyselyDatabaseType"],
    "kyselyAdapter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$mystery$2d$santa$2f$node_modules$2f$better$2d$auth$2f$dist$2f$adapters$2f$kysely$2d$adapter$2f$kysely$2d$adapter$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["kyselyAdapter"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$mystery$2d$santa$2f$node_modules$2f$better$2d$auth$2f$dist$2f$adapters$2f$kysely$2d$adapter$2f$index$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/mystery-santa/node_modules/better-auth/dist/adapters/kysely-adapter/index.mjs [middleware] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$mystery$2d$santa$2f$node_modules$2f$better$2d$auth$2f$dist$2f$adapters$2f$kysely$2d$adapter$2f$dialect$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/mystery-santa/node_modules/better-auth/dist/adapters/kysely-adapter/dialect.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$mystery$2d$santa$2f$node_modules$2f$better$2d$auth$2f$dist$2f$adapters$2f$kysely$2d$adapter$2f$kysely$2d$adapter$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/mystery-santa/node_modules/better-auth/dist/adapters/kysely-adapter/kysely-adapter.mjs [middleware] (ecmascript)");
}),
];

//# sourceMappingURL=06951_better-auth_dist_adapters_kysely-adapter_f1c14b6b._.js.map